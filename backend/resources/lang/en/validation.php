...
return [
    ...
    | à adapter ces messages à vos besoins.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Vous pouvez spécifier des messages personnalisés pour les attributs
    | en utilisant le format "attribute.rule" pour nommer les lignes.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes suivantes remplacent les noms d'attributs par défaut
    | par des noms plus conviviaux (ex : "adresse e-mail" au lieu de "email").
    |
    */
